...
class InspeccionVehiculoExportarType extends AbstractType
{
...
//            ->add('seIgnoraAccidente', CheckboxType::class, ['label' => 'accidente.cantidad.seIgnoraAccidente', 'required' => false, 'attr' => ['checked' => 'checked']])
            ...
            ->add('marcaVehiculo', CheckboxType::class, ['label' => 'vehiculo.marcaVehiculo', 'required' => false, 'attr' => ['checked' => 'checked']])
            ->add('modeloVehiculo', CheckboxType::class, ['label' => 'vehiculo.modeloVehiculo', 'required' => false, 'attr' => ['checked' => 'checked']])
            ->add('ano', CheckboxType::class, ['label' => 'vehiculo.ano', 'required' => false, 'attr' => ['checked' => 'checked']])
            ->add('color', CheckboxType::class, ['label' => 'vehiculo.color', 'required' => false, 'attr' => ['checked' => 'checked']])
            ->add('tipoVehiculo', CheckboxType::class, ['label' => 'vehiculo.tipoVehiculo', 'required' => false, 'attr' => ['checked' => 'checked']])
            ->add('direccionVehiculo', CheckboxType::class, ['label' => 'vehiculo.direccionVehiculo', 'required' => false, 'attr' => ['checked' => 'checked']])
            ->add('servicioVehiculo', CheckboxType::class, ['label' => 'vehiculo.servicioVehiculo', 'required' => false, 'attr' => ['checked' => 'checked']])
            ->add('maniobraVehiculo', CheckboxType::class, ['label' => 'vehiculo.maniobraVehiculo', 'required' => false, 'attr' => ['checked' => 'checked']])
            ->add('consecuenciaVehiculo', CheckboxType::class, ['label' => 'vehiculo.consecuenciaVehiculo', 'required' => false, 'attr' => ['checked' => 'checked']])
            ...
            ->add('submit', SubmitType::class, ['label' => 'exportacion.vehiculo.submit', 'attr' => ['class' => 'btn btn-primary btn-lg btn-block']])
        ;
    }
