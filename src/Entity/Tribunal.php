 ...
 * Tribunal
 *
 * @ORM\Table(name="Tribunal", uniqueConstraints={@ORM\UniqueConstraint(name="UQ_Tribunal_Codigo", columns={"Codigo"})})
...
class Tribunal
{
     ...
     * @var \Accidentes
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Accidente", mappedBy="tribunal")
     */
    private $accidentes;
    ...
    public function removeAccidente(Accidente $accidente): self
    {
        if ($this->accidentes->contains($accidente)) {
            ...
            if ($accidente->getTribunal() === $this) {
                $accidente->setTribunal(null);
            }
        }
