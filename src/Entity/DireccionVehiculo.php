 ...
 * DireccionVehiculo
 *
 * @ORM\Table(name="Direccion_Vehiculo", uniqueConstraints={@ORM\UniqueConstraint(name="UQ_Direccion_Vehiculo_Codigo", columns={"Codigo"})})
 * @ORM\Entity(repositoryClass="App\Repository\DireccionVehiculoRepository")
 * @UniqueEntity("codigo")
 */
class DireccionVehiculo
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\VehiculoAccidente", mappedBy="direccionVehiculo")
     */
    ...
    public function addVehiculosAccidente(VehiculoAccidente $vehiculosAccidente): self
    {
        if (!$this->vehiculosAccidente->contains($vehiculosAccidente)) {
            ...
            $vehiculosAccidente->setDireccionVehiculo($this);
        }
    ...
    public function removeVehiculosAccidente(VehiculoAccidente $vehiculosAccidente): self
    {
        if ($this->vehiculosAccidente->contains($vehiculosAccidente)) {
            ...
            if ($vehiculosAccidente->getDireccionVehiculo() === $this) {
                $vehiculosAccidente->setDireccionVehiculo(null);
            }
        }
