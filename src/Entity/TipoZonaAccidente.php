 ...
 * TipoZonaAccidente
 *
 * @ORM\Table(name="Tipo_Zona_Accidente", uniqueConstraints={@ORM\UniqueConstraint(name="UQ_Tipo_Zona_Accidente_Codigo", columns={"Codigo"})})
 * @ORM\Entity(repositoryClass="App\Repository\TipoZonaAccidenteRepository")
 * @UniqueEntity("codigo")
 */
class TipoZonaAccidente
{
    /**
     * @var int
     *
     ...
     * @var \Accidentes
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Accidente", mappedBy="tipoZonaAccidente")
     */
    private $accidentes;
    ...
    public function addAccidente(Accidente $accidente): self
    {
        if (!$this->accidentes->contains($accidente)) {
            ...
            $accidente->setTipoZonaAccidente($this);
        }
    ...
    public function removeAccidente(Accidente $accidente): self
    {
        if ($this->accidentes->contains($accidente)) {
            ...
            if ($accidente->getTipoZonaAccidente() === $this) {
                $accidente->setTipoZonaAccidente(null);
            }
        }
