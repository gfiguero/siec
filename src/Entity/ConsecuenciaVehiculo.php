 ...
 *
 * @ORM\Table(name="Consecuencia_Vehiculo", uniqueConstraints={@ORM\UniqueConstraint(name="UQ_Consecuencia_Vehiculo_Codigo", columns={"Codigo"})})
 * @ORM\Entity(repositoryClass="App\Repository\ConsecuenciaVehiculoRepository")
 * @UniqueEntity("codigo")
 */
class ConsecuenciaVehiculo
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\VehiculoAccidente", mappedBy="consecuenciaVehiculo")
     */
    ...
    public function addVehiculosAccidente(VehiculoAccidente $vehiculosAccidente): self
    {
        if (!$this->vehiculosAccidente->contains($vehiculosAccidente)) {
            ...
            $vehiculosAccidente->setConsecuenciaVehiculo($this);
        }
    ...
    public function removeVehiculosAccidente(VehiculoAccidente $vehiculosAccidente): self
    {
        if ($this->vehiculosAccidente->contains($vehiculosAccidente)) {
            ...
            if ($vehiculosAccidente->getConsecuenciaVehiculo() === $this) {
                $vehiculosAccidente->setConsecuenciaVehiculo(null);
            }
        }
