 ...
 * TipoDireccion
 *
 * @ORM\Table(name="Tipo_Direccion", uniqueConstraints={@ORM\UniqueConstraint(name="UQ_Tipo_Direccion_Codigo", columns={"Codigo"})})
 * @ORM\Entity(repositoryClass="App\Repository\TipoDireccionRepository")
 * @UniqueEntity("codigo")
 */
class TipoDireccion
{
     ...
     * @var \Accidentes
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Accidente", mappedBy="tipoDireccion")
     */
    private $accidentes;
    ...
    public function addAccidente(Accidente $accidente): self
    {
        if (!$this->accidentes->contains($accidente)) {
            ...
            $accidente->setTipoDireccion($this);
        }
    ...
    public function removeAccidente(Accidente $accidente): self
    {
        if ($this->accidentes->contains($accidente)) {
            ...
            if ($accidente->getTipoDireccion() === $this) {
                $accidente->setTipoDireccion(null);
            }
        }
