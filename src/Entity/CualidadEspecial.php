 ...
 * CualidadEspecial
 *
 * @ORM\Table(name="Cualidad_Especial", uniqueConstraints={@ORM\UniqueConstraint(name="UQ_Cualidad_Especial_Codigo", columns={"Codigo"})})
 * @ORM\Entity(repositoryClass="App\Repository\CualidadEspecialRepository")
 * @UniqueEntity("codigo")
 */
class CualidadEspecial
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\PersonaAccidente", mappedBy="cualidadEspecial")
     */
    ...
    public function addPersonasAccidente(PersonaAccidente $personasAccidente): self
    {
        if (!$this->personasAccidente->contains($personasAccidente)) {
            ...
            $personasAccidente->setCualidadEspecial($this);
        }
    ...
    public function removePersonasAccidente(PersonaAccidente $personasAccidente): self
    {
        if ($this->personasAccidente->contains($personasAccidente)) {
            ...
            if ($personasAccidente->getCualidadEspecial() === $this) {
                $personasAccidente->setCualidadEspecial(null);
            }
        }
