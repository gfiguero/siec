...
class CausaRepository extends ServiceEntityRepository
{
    ...
    public function findCausasConcurrentes($causaBasal)
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.id != :causaBasal')
            ->setParameter('causaBasal', $causaBasal)
            ->getQuery()
            ->getResult()
        ;
    }

    public function causasConcurrentes($causaBasal = null)
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.id != :causaBasal')
            ->setParameter('causaBasal', $causaBasal)
